...
/* CDC */
#define CDC_COMM_INTF_ID1        0x0
#define CDC_COMM_EP1              1
#define CDC_COMM_IN_EP_SIZE      10

#define CDC_DATA_INTF_ID1        0x00
#define CDC_DATA_EP1             2
#define CDC_DATA_OUT_EP_SIZE    64
#define CDC_DATA_IN_EP_SIZE     64


/* CDC */
#define CDC_COMM_INTF_ID2        0x2
#define CDC_COMM_EP2              4
#define CDC_COMM_IN_EP_SIZE      10

#define CDC_DATA_INTF_ID2        0x02
#define CDC_DATA_EP2             5
#define CDC_DATA_OUT_EP_SIZE    64
#define CDC_DATA_IN_EP_SIZE     64
