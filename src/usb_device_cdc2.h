...
#define CDC_TX_COMPLETING           3
    ...
    #define LINE_CODING_TARGET1 &cdc_notice1.SetLineCoding._byte[0]
    #define LINE_CODING_TARGET2 &cdc_notice2.SetLineCoding._byte[0]
    #define LINE_CODING_PFUNC1 &USB_CDC_SET_LINE_CODING_HANDLER
#else
    #define LINE_CODING_TARGET1 &line_coding1._byte[0]
    #define LINE_CODING_TARGET2 &line_coding2._byte[0]
 ...
 *****************************************************************************/
#define CDCSetBaudRate1(baudRate) {line_coding1.dwDTERate=baudRate;}
#define CDCSetBaudRate2(baudRate) {line_coding2.dwDTERate=baudRate;}
/******************************************************************************
    Function:
 ...
 *****************************************************************************/
#define CDCSetCharacterFormat1(charFormat) {line_coding1.bCharFormat=charFormat;}
#define CDCSetCharacterFormat2(charFormat) {line_coding2.bCharFormat=charFormat;}
 ...
 *****************************************************************************/
#define CDCSetParity1(parityType) {line_coding1.bParityType=parityType;}
#define CDCSetParity2(parityType) {line_coding2.bParityType=parityType;}
 ...
 *****************************************************************************/
#define CDCSetDataSize1(dataBits) {line_coding1.bDataBits=dataBits;}
#define CDCSetDataSize2(dataBits) {line_coding2.bDataBits=dataBits;}
 ...
 *****************************************************************************/
#define CDCSetLineCoding1(baud,format,parity,dataSize) {\
            CDCSetBaudRate1(baud);\
            CDCSetCharacterFormat1(format);\
            CDCSetParity1(parity);\
            CDCSetDataSize1(dataSize);\
        }
#define CDCSetLineCoding2(baud,format,parity,dataSize) {\
            CDCSetBaudRate2(baud);\
            CDCSetCharacterFormat2(format);\
            CDCSetParity2(parity);\
            CDCSetDataSize2(dataSize);\
        }
 ...
 *****************************************************************************/
#define USBUSARTIsTxTrfReady1()      (cdc_trf_state1 == CDC_TX_READY)
#define USBUSARTIsTxTrfReady2()      (cdc_trf_state2 == CDC_TX_READY)
/******************************************************************************
    Function:
 ...
 *****************************************************************************/
#define mUSBUSARTIsTxTrfReady1()     USBUSARTIsTxTrfReady1()
#define mUSBUSARTIsTxTrfReady2()     USBUSARTIsTxTrfReady2()
 ...
 *****************************************************************************/
#define mUSBUSARTTxRam1(pData,len)   \
{                                   \
    pCDCSrc1.bRam = pData;           \
    cdc_tx_len1 = len;               \
    cdc_mem_type1 = USB_EP0_RAM;     \
    cdc_trf_state1 = CDC_TX_BUSY;    \
}
#define mUSBUSARTTxRam2(pData,len)   \
{                                   \
    pCDCSrc2.bRam = pData;           \
    cdc_tx_len2 = len;               \
    cdc_mem_type2 = USB_EP0_RAM;     \
    cdc_trf_state2 = CDC_TX_BUSY;    \
}
 ...
 *****************************************************************************/
#define mUSBUSARTTxRom1(pData,len)   \
{                                   \
    pCDCSrc1.bRom = pData;           \
    cdc_tx_len1 = len;               \
    cdc_mem_type1 = USB_EP0_ROM;     \
    cdc_trf_state1 = CDC_TX_BUSY;    \
}

#define mUSBUSARTTxRom2(pData,len)   \
{                                   \
    pCDCSrc2.bRom = pData;           \
    cdc_tx_len2 = len;               \
    cdc_mem_type2 = USB_EP0_ROM;     \
    cdc_trf_state2 = CDC_TX_BUSY;    \
}
...
//DOM-IGNORE-BEGIN
/** E X T E R N S ************************************************************/
extern uint8_t cdc_rx_len1;
extern USB_HANDLE lastTransmission1;

extern uint8_t cdc_trf_state1;
extern POINTER pCDCSrc1;
extern uint8_t cdc_tx_len1;
extern uint8_t cdc_mem_type1;

extern CDC_NOTICE cdc_notice1;
extern LINE_CODING line_coding1;
...
extern uint8_t cdc_rx_len2;
extern USB_HANDLE lastTransmission2;

extern uint8_t cdc_trf_state2;
extern POINTER pCDCSrc2;
extern uint8_t cdc_tx_len2;
extern uint8_t cdc_mem_type2;

extern CDC_NOTICE cdc_notice2;
extern LINE_CODING line_coding2;
